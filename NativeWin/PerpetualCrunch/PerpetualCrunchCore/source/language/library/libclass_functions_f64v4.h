#if !defined ( LIBCLASS_FUNCTIONS_F64V4_H )
#define LIBCLASS_FUNCTIONS_F64V4_H
...
class ScriptLibraryClass_f64v4 : public ScriptLibraryClass
{
  public:
    ScriptLibraryClass_f64v4();
